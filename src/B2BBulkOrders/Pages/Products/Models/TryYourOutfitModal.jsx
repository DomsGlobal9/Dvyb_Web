...
const TryYourOutfitModal = ({ isOpen, onClose, onNext, garmentImage }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="bg-white p-6 rounded-3xl shadow-lg w-[450px] relative">
...
export default TryYourOutfitModal;
...
//                 3D Try on (coming soon )
//                 {/* <a 
//                   href="https://metaperson.avatarsdk.com/?_gl=1*kpajm*_ga*MTE2NTg0NTg1OS4xNzU0NTYwMzU5*_ga_RK28V9S3X1*czE3NTYwMzE5MzckbzE5JGcwJHQxNzU2MDMxOTM3JGo2MCRsMCRoMA..&_ga=2.60985324.1729637245.1755945562-1165845859.1754560359"
//                   target="_blank"
