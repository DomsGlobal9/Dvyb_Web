...
//     try {
//       await registerWithGoogle("b2c_users");
//       navigate("/");
...
//           </div>
//              <h4 className="underline absolute bottom-14 cursor-pointer left-4 flex justify-start items-start" 
//               onClick={()=>navigate("/B2BBulkOrders-login")}
//              >Become a Wholesaler</h4>
//         </div>
//       </div>
    ...
    <>
      ...
      <div className="flex h-screen my-4">
        ...
        <div className="relative flex w-full md:w-1/2 items-center justify-center bg-white">
          ...
          <h4
            className="underline absolute bottom-14 cursor-pointer left-4 flex justify-start items-start"
            onClick={() => navigate("/B2BBulkOrders-login")}
          >
            Become a Wholesaler
          </h4>
