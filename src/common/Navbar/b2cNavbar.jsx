...
const Navbar = () => {
  ...
  const handleAvtarClick = () => {
    ...
    requireAuth(() => navigate("/your-profile?tab=my-model"))
  }
 ...
 <div className="relative " ref={dropdownRef}>
            ...
            <button className="text-[15px] font-outfit text-[#595959]  font-normal  hidden lg:block" onClick={handleAvtarClick}>Avtar</button>
            </nav>
